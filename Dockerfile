...
RUN apt-get install wget -y && cd /opt/LBM_install/bs && wget https://file-1258430491.cos.ap-shanghai.myqcloud.com/lbm_data.zip && unzip lbm_data.zip && rm lbm_data.zip
